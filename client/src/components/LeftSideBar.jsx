...
// //       icon: (
// //         <Avatar className="w-6 h-6 text-black">
// //           {/* Add timestamp to force reload of the image */}
// //           <AvatarImage
// //             src={`${user?.data?.user?.profilePicture || ""}?${new Date().getTime()}`}
// //             alt={user?.data?.user?.username || "Profile"}
// //           />
// //           <AvatarFallback>CN</AvatarFallback>
// //         </Avatar>
...
//   // Append a timestamp to the profile picture URL to force reloading of the image
//   const profilePictureUrl = `${user?.data?.user?.profilePicture || ""}?${new Date().getTime()}`;
...
//         <Avatar className="w-6 h-6 text-black">
//           <AvatarImage
//             src={profilePictureUrl} // Use the profilePictureUrl with a timestamp
//             alt={user?.data?.user?.username || "Profile"}
//           />
//           <AvatarFallback>CN</AvatarFallback>
//         </Avatar>
...
export const LeftSideBar = () => {
  ...
  const completedUsername = username.slice(0, 10); // Limit username to 10 characters
  const profileName = user ? `${completedUsername}` : "Profile";
  console.log(userProfile?.profilePicture ,"ont the leftsidebar page");
  ...
  // Get the latest profile picture URL from Redux state
